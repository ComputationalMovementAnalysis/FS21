...
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-70-1.pdf}
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-70-2.pdf}
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-70-3.pdf}
...
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-85-2.pdf}
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-85-3.pdf}
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-85-4.pdf}
...
\NormalTok{  d[d}\OperatorTok{<}\DecValTok{0}\NormalTok{] <-}\StringTok{ }\OperatorTok{-}\DecValTok{1}
\NormalTok{  d[d}\OperatorTok{==}\DecValTok{0}\NormalTok{] <-}\StringTok{ }\DecValTok{1}
...
\NormalTok{  )}
\NormalTok{## # A tibble: 20 x 7}
\NormalTok{##          X       Y nMinus2 nMinus1 nPlus1 nPlus2 stepMean}
\NormalTok{##      <dbl>   <dbl>   <dbl>   <dbl>  <dbl>  <dbl>    <dbl>}
\NormalTok{##  1  0.0187  -0.596   NA     NA      2.19    3.26     1.72}
\NormalTok{##  2 -0.166   -2.78    NA      2.19   1.53    3.42     1.72}
\NormalTok{##  3 -1.54    -3.46     3.26   1.53   2.20    3.40     1.72}
\NormalTok{##  4 -2.14    -5.58     3.42   2.20   1.30    1.78     1.72}
\NormalTok{##  5 -1.84    -6.84     3.40   1.30   0.540   1.34     1.72}
\NormalTok{##  6 -1.45    -7.21     1.78   0.540  1.39    2.21     1.72}
\NormalTok{##  7 -2.66    -7.90     1.34   1.39   0.945   2.22     1.72}
\NormalTok{##  8 -3.02    -8.77     2.21   0.945  1.63    1.92     1.72}
\NormalTok{##  9 -4.65    -8.88     2.22   1.63   0.361   2.27     1.72}
\NormalTok{## 10 -4.91    -9.13     1.92   0.361  2.16    2.68     1.72}
\NormalTok{## 11 -3.80   -11.0      2.27   2.16   0.760   1.03     1.72}
\NormalTok{## 12 -3.05   -11.1      2.68   0.760  0.997   1.38     1.72}
\NormalTok{## 13 -3.29   -10.1      1.03   0.997  1.00    2.10     1.72}
\NormalTok{## 14 -2.30    -9.91     1.38   1.00   1.57    2.94     1.72}
\NormalTok{## 15 -1.56   -11.3      2.10   1.57   1.44    1.38     1.72}
\NormalTok{## 16 -1.47   -12.7      2.94   1.44   1.02    1.81     1.72}
\NormalTok{## 17 -2.42   -12.4      1.38   1.02   1.77    2.21     1.72}
\NormalTok{## 18 -2.62   -14.1      1.81   1.77   0.981   1.71     1.72}
\NormalTok{## 19 -1.69   -14.4      2.21   0.981  0.811  NA        1.72}
\NormalTok{## 20 -1.21   -15.1      1.71   0.811 NA      NA        1.72}
\end{Highlighting}
\end{Shaded}

Since we want the mean value \emph{per Row}, we have to explicitly
specify this before \texttt{mutate()} with the function
\texttt{rowwise()}. Note the new grouping variable
\texttt{\textless{}by\ row\textgreater{}} when printing the dataframe to
the console.
...
\NormalTok{df}
\NormalTok{## Source: local data frame [20 x 7]}
\NormalTok{## Groups: <by row>}
\NormalTok{## }
\NormalTok{## # A tibble: 20 x 7}
\NormalTok{##          X       Y nMinus2 nMinus1 nPlus1 nPlus2 stepMean}
\NormalTok{##      <dbl>   <dbl>   <dbl>   <dbl>  <dbl>  <dbl>    <dbl>}
\NormalTok{##  1  0.0187  -0.596   NA     NA      2.19    3.26    NA   }
\NormalTok{##  2 -0.166   -2.78    NA      2.19   1.53    3.42    NA   }
\NormalTok{##  3 -1.54    -3.46     3.26   1.53   2.20    3.40     2.60}
\NormalTok{##  4 -2.14    -5.58     3.42   2.20   1.30    1.78     2.17}
\NormalTok{##  5 -1.84    -6.84     3.40   1.30   0.540   1.34     1.64}
\NormalTok{##  6 -1.45    -7.21     1.78   0.540  1.39    2.21     1.48}
\NormalTok{##  7 -2.66    -7.90     1.34   1.39   0.945   2.22     1.47}
\NormalTok{##  8 -3.02    -8.77     2.21   0.945  1.63    1.92     1.68}
\NormalTok{##  9 -4.65    -8.88     2.22   1.63   0.361   2.27     1.62}
\NormalTok{## 10 -4.91    -9.13     1.92   0.361  2.16    2.68     1.78}
\NormalTok{## 11 -3.80   -11.0      2.27   2.16   0.760   1.03     1.55}
\NormalTok{## 12 -3.05   -11.1      2.68   0.760  0.997   1.38     1.45}
\NormalTok{## 13 -3.29   -10.1      1.03   0.997  1.00    2.10     1.28}
\NormalTok{## 14 -2.30    -9.91     1.38   1.00   1.57    2.94     1.72}
\NormalTok{## 15 -1.56   -11.3      2.10   1.57   1.44    1.38     1.62}
\NormalTok{## 16 -1.47   -12.7      2.94   1.44   1.02    1.81     1.80}
\NormalTok{## 17 -2.42   -12.4      1.38   1.02   1.77    2.21     1.59}
\NormalTok{## 18 -2.62   -14.1      1.81   1.77   0.981   1.71     1.57}
\NormalTok{## 19 -1.69   -14.4      2.21   0.981  0.811  NA       NA   }
\NormalTok{## 20 -1.21   -15.1      1.71   0.811 NA      NA       NA}
\end{Highlighting}
\end{Shaded}

We can now determin if an animal is moving or not by specifying a
threshold on \texttt{stepMean}
...
\NormalTok{df}
\NormalTok{## Source: local data frame [20 x 8]}
\NormalTok{## Groups: <by row>}
\NormalTok{## }
\NormalTok{## # A tibble: 20 x 8}
\NormalTok{##          X       Y nMinus2 nMinus1 nPlus1 nPlus2 stepMean moving}
\NormalTok{##      <dbl>   <dbl>   <dbl>   <dbl>  <dbl>  <dbl>    <dbl> <lgl> }
\NormalTok{##  1  0.0187  -0.596   NA     NA      2.19    3.26    NA    NA    }
\NormalTok{##  2 -0.166   -2.78    NA      2.19   1.53    3.42    NA    NA    }
\NormalTok{##  3 -1.54    -3.46     3.26   1.53   2.20    3.40     2.60 TRUE  }
\NormalTok{##  4 -2.14    -5.58     3.42   2.20   1.30    1.78     2.17 TRUE  }
\NormalTok{##  5 -1.84    -6.84     3.40   1.30   0.540   1.34     1.64 TRUE  }
\NormalTok{##  6 -1.45    -7.21     1.78   0.540  1.39    2.21     1.48 FALSE }
\NormalTok{##  7 -2.66    -7.90     1.34   1.39   0.945   2.22     1.47 FALSE }
\NormalTok{##  8 -3.02    -8.77     2.21   0.945  1.63    1.92     1.68 TRUE  }
\NormalTok{##  9 -4.65    -8.88     2.22   1.63   0.361   2.27     1.62 TRUE  }
\NormalTok{## 10 -4.91    -9.13     1.92   0.361  2.16    2.68     1.78 TRUE  }
\NormalTok{## 11 -3.80   -11.0      2.27   2.16   0.760   1.03     1.55 TRUE  }
\NormalTok{## 12 -3.05   -11.1      2.68   0.760  0.997   1.38     1.45 FALSE }
\NormalTok{## 13 -3.29   -10.1      1.03   0.997  1.00    2.10     1.28 FALSE }
\NormalTok{## 14 -2.30    -9.91     1.38   1.00   1.57    2.94     1.72 TRUE  }
\NormalTok{## 15 -1.56   -11.3      2.10   1.57   1.44    1.38     1.62 TRUE  }
\NormalTok{## 16 -1.47   -12.7      2.94   1.44   1.02    1.81     1.80 TRUE  }
\NormalTok{## 17 -2.42   -12.4      1.38   1.02   1.77    2.21     1.59 TRUE  }
\NormalTok{## 18 -2.62   -14.1      1.81   1.77   0.981   1.71     1.57 TRUE  }
\NormalTok{## 19 -1.69   -14.4      2.21   0.981  0.811  NA       NA    NA    }
\NormalTok{## 20 -1.21   -15.1      1.71   0.811 NA      NA       NA    NA}
...
\NormalTok{  )}
\NormalTok{## # A tibble: 8 x 4}
\NormalTok{##   boolvec cumsum boolvec_inverse cumsum2}
\NormalTok{##   <lgl>    <int> <lgl>             <int>}
\NormalTok{## 1 FALSE        0 TRUE                  1}
\NormalTok{## 2 TRUE         1 FALSE                 1}
\NormalTok{## 3 TRUE         2 FALSE                 1}
\NormalTok{## 4 TRUE         3 FALSE                 1}
\NormalTok{## 5 FALSE        3 TRUE                  2}
\NormalTok{## 6 FALSE        3 TRUE                  3}
\NormalTok{## 7 TRUE         4 FALSE                 3}
\NormalTok{## 8 TRUE         5 FALSE                 3}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  )}
\NormalTok{## # A tibble: 8 x 3}
\NormalTok{##   boolvec cumsum cumsum2}
\NormalTok{##   <lgl>    <int>   <int>}
\NormalTok{## 1 FALSE        0       1}
\NormalTok{## 2 TRUE         1       1}
\NormalTok{## 3 TRUE         2       1}
\NormalTok{## 4 TRUE         3       1}
\NormalTok{## 5 FALSE        3       2}
\NormalTok{## 6 FALSE        3       3}
\NormalTok{## 7 TRUE         4       3}
\NormalTok{## 8 TRUE         5       3}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{## install.packages("SimilarityMeasures")}
\NormalTok{## }
\NormalTok{## # The following packages are for optional tasks:}
\NormalTok{## install.packages("plotly")}
\NormalTok{## }
\NormalTok{## # You don't really need the following packages,}
\NormalTok{## # we just use them in our figures}
...
\StringTok{    }\KeywordTok{filter}\NormalTok{(TrajID }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,idx))}
...
\begin{Highlighting}[]
\NormalTok{## }
\NormalTok{## meanmeetpoints <- wildschwein_join %>%}
\NormalTok{##   filter(meet) %>%}
\NormalTok{##   mutate(}
\NormalTok{##     E.mean = (E.x+E.y)/2,}
\NormalTok{##     N.mean = (N.x+N.y)/2}
\NormalTok{## }
\NormalTok{##   )}
\NormalTok{## }
\NormalTok{## library(plotly)}
\NormalTok{## plot_ly(wildschwein_join, x = ~E.x,y = ~N.x, z = ~DatetimeRound,type = "scatter3d", mode = "lines") %>%}
\NormalTok{##   add_trace(wildschwein_join, x = ~E.y,y = ~N.y, z = ~DatetimeRound) %>%}
\NormalTok{##   add_markers(data = meanmeetpoints, x = ~E.mean,y = ~N.mean, z = ~DatetimeRound) %>%}
\NormalTok{##   layout(scene = list(xaxis = list(title = 'E'),}
\NormalTok{##                       yaxis = list(title = 'N'),}
\NormalTok{##                       zaxis = list(title = 'Time')))}
\NormalTok{## }
\NormalTok{## wildschwein_join %>%}
\NormalTok{##   filter(DatetimeRound<"2015-04-04") %>%}
\NormalTok{##   plot_ly(x = ~E.x,y = ~N.x, z = ~DatetimeRound,type = "scatter3d", mode = "lines") %>%}
\NormalTok{##   add_trace(wildschwein_join, x = ~E.y,y = ~N.y, z = ~DatetimeRound) %>%}
\NormalTok{##   add_markers(data = meanmeetpoints, x = ~E.mean,y = ~N.mean, z = ~DatetimeRound) %>%}
\NormalTok{##   layout(scene = list(xaxis = list(title = 'E'),}
\NormalTok{##                       yaxis = list(title = 'N'),}
...
\tightlist
\item
  You are able to process spatial data (vector and raster) within R,
  including creating simple maps within R.
\item
  You know basic operations for semantically annotating your
  trajectories with geographic context.
\end{itemize}
...
\subsection{Tasks 1: Import and visualize spatial
data}\label{tasks-1-import-and-visualize-spatial-data}
