...
\NormalTok{pk100\_BE }\OtherTok{\textless{}{-}} \FunctionTok{brick}\NormalTok{(}\StringTok{"00\_Rawdata/pk100\_BE\_2056.tif"}\NormalTok{)}

\NormalTok{pk100\_BE}
\DocumentationTok{\#\# class      : RasterBrick }
\DocumentationTok{\#\# dimensions : 1821, 2321, 4226541, 4  (nrow, ncol, ncell, nlayers)}
\DocumentationTok{\#\# resolution : 5, 5  (x, y)}
\DocumentationTok{\#\# extent     : 2567000, 2578605, 1199996, 1209101  (xmin, xmax, ymin, ymax)}
\DocumentationTok{\#\# crs        : +proj=somerc +lat\_0=46.9524055555556 +lon\_0=7.43958333333333 +k\_0=1 +x\_0=2600000 +y\_0=1200000 +ellps=bessel +units=m +no\_defs }
\DocumentationTok{\#\# source     : C:/Users/bako/Desktop/Kurse/FS21/FS21/00\_Rawdata/pk100\_BE\_2056.tif }
\DocumentationTok{\#\# names      : pk100\_BE\_2056.1, pk100\_BE\_2056.2, pk100\_BE\_2056.3, pk100\_BE\_2056.4 }
\DocumentationTok{\#\# min values :               0,               0,               0,               0 }
\DocumentationTok{\#\# max values :             255,             255,             255,             255}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-54-1.pdf} \includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-54-2.pdf} \includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-54-3.pdf}
...
!(\protect\hyperlink{ref-laube2011}{Laube and Purves 2011}: \emph{Black points are used in calculation of movement parameters (e.g.~speed) at a given termporal scale.})(02\_Images/laube\_2011\_2.jpg)
...
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-67-1.pdf} \includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-67-2.pdf} \includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-67-3.pdf} \includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-67-4.pdf}
...
\DocumentationTok{\#\#  [1] {-}0.08145389  0.16710397 {-}0.21160835 {-}0.23824666 {-}0.58580212 {-}0.09891376}
\DocumentationTok{\#\#  [7] {-}0.10375999 {-}0.53739296          NA          NA}
...
\DocumentationTok{\#\#  [1]  0.07207105 {-}0.12637177 {-}0.21885298 {-}0.30619012 {-}0.32588506 {-}0.13796671}
\DocumentationTok{\#\#  [7] {-}0.53054985          NA          NA          NA}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Input: Segmentation \#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wildschwein\_filter }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(TierID) }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_sf}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =}\NormalTok{ TierID),}\AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{wildschwein\_filter }\OtherTok{\textless{}{-}}\NormalTok{ wildschwein\_filter }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(TierID }\SpecialCharTok{!=} \StringTok{"018A"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 1 002A   Sabi        12275 2015{-}03{-}31 22:00:28  47.0  7.05 2.57e6 1.21e6}
\DocumentationTok{\#\# 2 002A   Sabi        12275 2015{-}03{-}31 22:15:44  47.0  7.05 2.57e6 1.21e6}
\DocumentationTok{\#\# 3 002A   Sabi        12275 2015{-}03{-}31 22:30:44  47.0  7.05 2.57e6 1.21e6}
\DocumentationTok{\#\# 4 002A   Sabi        12275 2015{-}03{-}31 22:46:04  47.0  7.05 2.57e6 1.21e6}
\DocumentationTok{\#\# 5 002A   Sabi        12275 2015{-}03{-}31 23:00:17  47.0  7.05 2.57e6 1.21e6}
\DocumentationTok{\#\# 6 002A   Sabi        12275 2015{-}03{-}31 23:15:12  47.0  7.05 2.57e6 1.21e6}
...
\NormalTok{number\_seq }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(bool)\{}
\NormalTok{  fac }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(}\FunctionTok{ifelse}\NormalTok{(bool,}\DecValTok{1}\SpecialCharTok{+}\FunctionTok{cumsum}\NormalTok{(}\SpecialCharTok{!}\NormalTok{bool),}\ConstantTok{NA}\NormalTok{))}
  \FunctionTok{levels}\NormalTok{(fac) }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(}\FunctionTok{levels}\NormalTok{(fac))}
  \FunctionTok{return}\NormalTok{(fac)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-135-1.pdf}
...
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-143-1.pdf}
...
\begin{figure}
\centering
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\begin{figure}
\centering
\includegraphics{patterns-and-trends_files/figure-latex/unnamed-chunk-148-1.pdf}
