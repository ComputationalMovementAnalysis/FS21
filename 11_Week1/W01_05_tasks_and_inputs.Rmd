...
```{r echo = FALSE, include=TRUE, eval = TRUE, code =  mydecrypt("11_Week1/solutions/task_3.R",".passphrase")}
...
```{r echo = FALSE, include=TRUE, eval = TRUE, code =  mydecrypt("11_Week1/solutions/task_4.R",".passphrase")}
