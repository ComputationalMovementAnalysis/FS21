...
- make sure you have read and followed the instructions in section [Preperation](#w1-preperation)
- In RStudio, open the RStudio Project you created for this week if you havent dont so already. You can see that you are in an RStudio Project if the project's name is visible next to the little RStudio logo in the top right corner of RStudio (otherwise it will read "Project: (None)".
- Download the wildboar movement data ()

Then, create a new RMarkdown File and start by loading the tidyverse:
...
```{r code =  mydecrypt("11_Week1/solutions/task_2.R",".passphrase"), opts.label="solution_showOutput"}
```
