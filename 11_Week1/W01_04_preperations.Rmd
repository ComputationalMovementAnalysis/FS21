...
Now it is time to introduce yourself to git. In the terminal[^terminal], enter your name and email address by entering the following commands:
...
[^terminal]: There is a terminal built into RStudio which you can use for this. By default, it is situated in the bottom left corner in the tab named "Terminal"
