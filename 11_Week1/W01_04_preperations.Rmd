...
Every Windows comes with two different shell installations: "Command prompt" and "PowerShell"[^launch]. After installing Git we now have a third option, "Git Bash". The shell terminal in RStudio uses "Command prompt" per default, in [the last task][#configure-rstudio] we just switched the shell to "Git Bash".
