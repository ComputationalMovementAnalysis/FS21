...
pander::pandoc.image("_book/patterns-and-trends_files/figure-html/unnamed-chunk-68-1.png","Interactive map/plot is only a screenshot of the actual interactive map.")
```
