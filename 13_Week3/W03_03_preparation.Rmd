...
Now you have a normal RStudio Project *without* Git version control and without a Github connection. This is a typical situation for a project that you started without version control in mind. Let's add these to elements in the following steps.
