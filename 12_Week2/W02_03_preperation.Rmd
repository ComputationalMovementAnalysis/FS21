...
Last week, you worked with git on your local machine, with no way of synchronising your changes with a cloud server. This week, you will use Github to sync your changes. Create a Github account on [github.com](https://github.com/) (it's free of course). Use the email adress that you configured in git last week! If you are not sure which mail you used, type `git config user.email` in the console. When choosing a username in github, consider the following tips: 
...
Now you can create a Repository on Github that you can afterwards connect to your RStudio project from week 1. To do this go to [github.com/new](https://github.com/new) and fill in the following information:
...
You will be forwarded to a new page with instructions. You can swich between instructions for `https` and `SSH` by clicking on the appropriate button. Make sure you choose `https`, keep this page open and open RStudio.
