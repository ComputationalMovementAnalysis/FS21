...
Click on `Create repository`, then on the green button "Code". Select HTTPS (it might already be selected) and then copy the URL by clicking on the clipboard symbol. The URL should look something list this ``r glue::glue("https://github.com/YOUR-GITHUB-USERNAME/{reponame}.git")``
