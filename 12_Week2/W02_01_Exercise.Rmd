...
#### Filter
To do so, filter your data to positions with a sampling interval between 40 and 80 seconds and save it to a new variable (we will use `wildschwein_BE_1`). From this subset, take the first 100 positions[^201] for the following task. 
