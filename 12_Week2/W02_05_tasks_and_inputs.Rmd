...
3. Download the wildboar movement data again, and save it to your new projects directory `r download_url("wildschwein_BE.csv","00_Rawdata")` (right click "Save target as..")
